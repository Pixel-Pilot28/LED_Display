...
sport_names = ["soccer", "soccer", "soccer", "soccer", "soccer"]
# The name of the corresponding leagues you want to follow
sport_leagues = ["eng.1", "ger.1", "ufea.champions", "fifa.world", "conmebol.america"]
# Directory to match CircuitPython code folder names
bitmap_directories = ["logo","logo","logo","logo","logo", ]
